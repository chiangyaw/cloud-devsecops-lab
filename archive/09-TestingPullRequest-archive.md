# Cloud DevSecOps Lab
## Test Pull Request
Check that all three integrations are working by kicking off a pull request. 

1. Go back to your Cloud9 IDE. Create a new directory under Terraform called ```simple_instance```, and create a new file in it called ```s3.tf```. Add the following code to the file and save:
```
provider "aws" {
...
```
![alt text](/resources/cloud9-create-folder.png?raw=true)
![alt text](/resources/cloud9-create-file.png?raw=true)

3. Commit the changes to your GitHub repository under a separate branch called ```patch-1``` by typing the following commands in your terminal:
```
git checkout -b patch-1
git add terraform/simple_instance/*
git commit -m "added new tf file"
git push
```
